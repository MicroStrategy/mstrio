...
This R package was designed to give data scientists a way to extract data from MicroStrategy cubes and reports, and additionally, create new cubes in the MicroStrategy environment.
